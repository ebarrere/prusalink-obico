...
from .prusalink_conn import PrusaLinkConn
...
class App(object):
    ...
    def start(self, args):
        ...
        if args.dev_mode:
            ...
            self.moonrakerconn = PrusaLinkConn(config, self.sentry, self.push_event,)
            # Blocking call. When continued, the conn is guaranteed to be properly configured. Also config object is updated with printer objects
        ...
        try:
            ...
            try:
                ...
                pass  # Moonraker-DB only; no PrusaLink equivalent
