...
class MoonrakerConfig:
    # Repurposed for PrusaLink (parsed from the [prusalink] section). Kept the
    # class/attr name so the Obico-facing code (which never reads it) is untouched.
    host: str = '127.0.0.1'
    port: int = 80
